...
After switching the network adapter back to the LAN Segment, agent connectivity to the Wazuh Manager was verified through the Wazuh Dashboard on Ubuntu Server. The Windows 11 agent appears as **Active** in the agent list.
